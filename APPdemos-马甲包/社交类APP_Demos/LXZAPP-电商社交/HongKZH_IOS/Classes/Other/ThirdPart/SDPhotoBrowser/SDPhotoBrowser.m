...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    if (currentIndex>= self.sourceImagesContainerView.subviews.count) {
        currentIndex = 0;
    }
...
- (void)showFirstImage
{
    NSInteger pos = self.currentImageIndex;
    if (self.currentImageIndex >= self.sourceImagesContainerView.subviews.count) {
        pos = 0;
    }
    UIView *sourceView = self.sourceImagesContainerView.subviews[pos];
