...
@interface HKUserContentViewController () <UITextViewDelegate>
...
@implementation HKUserContentViewController
...
//上传接口
- (void)uploadData {
    [HK_MyApplyTool UpdateUserContent:self.textView.text SuccessBlock:^(id res) {
...
- (void)setUpUI {
    ...
    UITextView *textView = [HKComponentFactory textViewWithFrame:CGRectMake(16, 16, kScreenWidth-16*2, self.containerView.height-16*2) font:[UIFont fontWithName:PingFangSCRegular size:15.f] textColor:RGB(153,153,153) placeHolder:@"详细描述一下你自己，字数控制在10-800字" supperView:self.containerView];
