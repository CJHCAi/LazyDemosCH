...
@property (nonatomic, strong) NSMutableArray *smilesArray, *leftBlinksArray, *rightBlinksArray, *noSmileArray;
...
-(GestureType)checkIfRegisteredGesturesAndUpdateProgress
{
    ...
    if ([self updateProgressAndCheckIfRegisteredGesture:GestureTypeSmile neededTimeForGesture:kTimeNeedsToSmile]) {
        ...
        gestureToReturn = GestureTypeNoGesture;
    }
...
//    
//    if ([self updateProgressAndCheckIfRegisteredGesture:GestureTypeNoGesture neededTimeForGesture:kTimeNeedsToWink]) {
//        gestureToReturn = GestureTypeNoGesture;
//    }
...
-(id)init
{
    ...
    self.noSmileArray = [NSMutableArray arrayWithCapacity:kNumberOfRecordsToStore];
...
-(NSMutableArray *)getArrayBasedOnGestureType:(GestureType)gestureType
{
    ...
    } else if (gestureType == GestureTypeNoGesture)
    {
        array = self.noSmileArray;
    }
    return array;
}
