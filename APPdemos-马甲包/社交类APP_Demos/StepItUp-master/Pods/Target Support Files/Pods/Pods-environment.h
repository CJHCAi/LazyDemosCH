...
// LKAlarmManager
#define COCOAPODS_POD_AVAILABLE_LKAlarmManager
#define COCOAPODS_VERSION_MAJOR_LKAlarmManager 0
#define COCOAPODS_VERSION_MINOR_LKAlarmManager 3
#define COCOAPODS_VERSION_PATCH_LKAlarmManager 0
