...
- (void)pagerController:(TYTabPagerController *)pagerController configreCell:(UICollectionViewCell *)cell forItemTitle:(id)title atIndexPath:(NSIndexPath *)indexPath;

- (BOOL)pagerController:(TYTabPagerController *)pagerController canMoveItemAtIndexPath:(NSIndexPath *)indexPath;
...
@property (nonatomic, strong, readonly) UIView *pagerBarUnderLineView;
...
@property (nonatomic, assign) BOOL isShowUnderLineView;
...
@property (nonatomic, assign) CGFloat leftEdging;
