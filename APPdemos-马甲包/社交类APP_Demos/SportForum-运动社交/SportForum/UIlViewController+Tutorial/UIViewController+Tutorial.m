...
- (void)startTapTutorialWithInfo: (NSString *)infoText
    ...
    tutorialView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:hideBackground ? 1.0 : 0.7];
    tutorialView.alpha = 0.0;
    
    [self.view addSubview: tutorialView];
    [self.view bringSubviewToFront:tutorialView];
    
    DKCircleImageView *touchView = [[DKCircleImageView alloc] initWithFrame:CGRectMake(0, 0, 45, 45)];
