...
- (id)pagerController:(TYPagerController *)pagerController titleForIndex:(NSInteger)index;
...
- (void)pagerControllerDidEndDecelerating:(TYPagerController *)pagerController;
...
@property (nonatomic,copy) dispatch_block_t willDraggingBlock;

@property (nonatomic, assign) BOOL fullScreenLayout;
