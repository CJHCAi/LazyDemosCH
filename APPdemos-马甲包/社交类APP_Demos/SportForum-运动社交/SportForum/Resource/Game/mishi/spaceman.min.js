function main() {
	var e = {
		...
		initCanvas: function() {
			jsGame.canvas.screen.getTouch() ? (window.scrollTo(0, -5), e.height = 800, e.width = 480, jsGame.canvas.screen.setHeight(e.height), e.top = 0, e.left = 0) : (e.height = 640, e.width = 480, jsGame.canvas.screen.setHeight(e.height), jsGame.canvas.screen.setWidth(e.width), e.top = 0, e.left = (window.innerWidth - e.width) / 2);
			e.init();
	...
	jsGame.pageLoad(function(t) {
		...
		nt = function(e, n, r) {
			t.canvas.beginPath();
			t.canvas.lineWidth(2 * (n + 2)).strokeStyle("rgba(0,0,0,0)");
			...
			t.canvas.stroke();
			t.canvas.lineWidth(2 * n).strokeStyle("#000000");
		...
		t.run(function() {
			...
			a.draw("english", 0, a.isPressed ? 1 : 0, a.w, a.h, a.x, a.y, a.w, a.h);
				...
				"ENG" == P ? (f.draw("startE", 0, f.isPressed ? 1 : 0, f.w, f.h, f.x, f.y, f.w, f.h)) : (f.draw("start", 0, f.isPressed ? 1 : 0, f.w, f.h, f.x, f.y, f.w, f.h))
			} else if (D == O) j(),
			t.canvas.drawImage("intro", (t.canvas.screen.getWidth() - t.getImage("intro").width) / 2, 200);
			else if (D == _) {
				j();
				...
				"ENG" == P ? (t.canvas.drawImage("scoreE", n + 30, r + 200).drawNumber(v.mission, "sz", 8, 15, n + 84, r + 202, !1), t.canvas.drawImage("HscoreE", n + 30, r + 170).drawNumber(H, "sz", 8, 15, n + 124, r + 172, !1)) : (t.canvas.drawImage("score", n + 30, r + 200).drawNumber(v.mission, "sz", 8, 15, n + 84, r + 202, !1), t.canvas.drawImage("Hscore", n + 30, r + 170).drawNumber(H, "sz", 8, 15, n + 124, r + 172, !1))
