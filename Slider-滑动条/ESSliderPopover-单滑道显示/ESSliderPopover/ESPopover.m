...
- (void)drawRect:(CGRect)rect
{
    ...
    // Subframe
    CGRect subFrame = CGRectMake(CGRectGetMinX(frame) + floor((CGRectGetWidth(frame) - 11) * 0.51724 + 0.5), CGRectGetMinY(frame) + CGRectGetHeight(frame) - 9, 11, 9);
    ...
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(subFrame) + 10.64, CGRectGetMinY(subFrame) + 1.5)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(subFrame) + 5.5, CGRectGetMinY(subFrame) + 8)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(subFrame) + 0.36, CGRectGetMinY(subFrame) + 1.5)];
