...
- (void)setupLabel {
    ...
    _leftToRight = YES;
    _textSelectable = YES;
    _selectionColor = [UIColor darkGrayColor];//[UIColor colorWithWhite:0.9 alpha:1.0];
    
    _attributesText = @{NSForegroundColorAttributeName: [UIColor darkGrayColor], NSFontAttributeName: [UIFont boldSystemFontOfSize:12]};
    _attributesHandle = @{NSForegroundColorAttributeName: [UIColor colorWithRed:41.0/255.0 green:173.0/255.0 blue:240.0/255.0 alpha:1.0], NSFontAttributeName: [UIFont boldSystemFontOfSize:12]};
    _attributesHashtag = @{NSForegroundColorAttributeName: [UIColor darkGrayColor], NSFontAttributeName: [UIFont boldSystemFontOfSize:12]};
    _attributesLink = @{NSForegroundColorAttributeName: [UIColor darkGrayColor], NSFontAttributeName: [UIFont boldSystemFontOfSize:12]};
...
- (void)setAttributes:(NSDictionary *)attributes {
    ...
    if (!attributes[NSForegroundColorAttributeName]) {
        NSMutableDictionary *copy = [attributes mutableCopy];
        copy[NSForegroundColorAttributeName] = [UIColor darkGrayColor];
        attributes = [NSDictionary dictionaryWithDictionary:copy];
    }
