...
#define kTitleFontSize          SCREEN_ADJUST(13)
#define kButtonTitleFontSize    SCREEN_ADJUST(15)

#define kActionSheetViewColor           [UIColor colorWithRed:127.0f/255.0f green:127.0f/255.0f blue:127.0f/255.0f alpha:1.0f]
...
+ (void)sr_showActionSheetViewWithTitle:(NSString *)title
                 ...
                 destructiveButtonTitle:(NSString *)destructiveButtonTitle
                      otherButtonTitles:(NSArray  *)otherButtonTitles
                       selectSheetBlock:(FootSheetDidSelectSheetBlock)selectSheetBlock
{
...
- (void)setupActionSheetView {
    ...
    if (_destructiveButtonTitle && _destructiveButtonTitle.length > 0) {
        ...
        [destructiveButton setTitleColor:kTitleFontColor forState:UIControlStateNormal];
   ...
   // dividerView.backgroundColor =[UIColor redColor];
    ...
    offsetY += kRowButtonHeight;
    _actionSheetHeight = offsetY+SafeAreaBottomHeight;
    if (SafeAreaBottomHeight>0) {
        UIView * booV =[[UIView alloc] initWithFrame:CGRectMake(0,_actionSheetHeight-SafeAreaBottomHeight,kScreenWidth,SafeAreaBottomHeight)];
        booV.backgroundColor =[UIColor whiteColor];
        [_actionSheetView addSubview:booV];
    }
