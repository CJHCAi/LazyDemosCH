 ...
 */
@interface OLFacebookImagePickerController : UINavigationController <PECropViewControllerDelegate>

/**
 The image picker’s delegate object.
 */
@property (nonatomic, weak) id <UINavigationControllerDelegate, OLFacebookImagePickerControllerDelegate, PECropViewControllerDelegate> delegate;
