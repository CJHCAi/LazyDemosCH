...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/LXMThirdLoginManager/LXMThirdLoginManager/QQSDK/QQ_SDK_V2.9/TencentOpenApi_IOS_Bundle.bundle"
  install_resource "${PODS_ROOT}/LXMThirdLoginManager/LXMThirdLoginManager/SinaWeiboSDK/libWeiboSDK/WeiboSDK.bundle"
