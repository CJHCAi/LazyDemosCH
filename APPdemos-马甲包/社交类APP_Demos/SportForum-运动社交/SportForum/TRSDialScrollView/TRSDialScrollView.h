...
/**
 * The current value view length in the scroll view
 */
@property (assign, nonatomic) NSInteger curValueViewLength;
...
// The Data Format
@property (assign, nonatomic) DATA_FORMAT_TYPE dataFormat;
