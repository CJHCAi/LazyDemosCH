//
//  BGSCircleTextViewWithPlaceholder.m
//  HongKZH_IOS
//
...
#import "BGSCircleTextViewWithPlaceholder.h"
...
@interface BGSCircleTextViewWithPlaceholder ()
@property (strong, nonatomic) UILabel *lblPlaceholder;
@end

@implementation BGSCircleTextViewWithPlaceholder
...
- (void)editDidBegin:(NSNotification *)notification
{
    ...
    self.lblPlaceholder.frame = CGRectMake(frameLbl.origin.x+3, frameLbl.origin.y+2, widthlbl, heightLbl-30);
    if (self.lblPlaceholder)
    {
        [self.lblPlaceholder removeFromSuperview];
        [self setLblPlaceholder:Nil];
...
-(void)configLabel
{
    ...
    CGRect frameLblUpd = CGRectMake(frameLbl.origin.x+3, frameLbl.origin.y+2, widthlbl, 50);
    if (!self.lblPlaceholder)
    {
...
-(void)changePlaceholderSize
{
    ...
    self.lblPlaceholder.frame = CGRectMake(frameLbl.origin.x+3+5, frameLbl.origin.y-30+2-30, widthlbl, heightLbl-30);
}
