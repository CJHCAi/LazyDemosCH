...
#define ACTION_SHEET_DELETE_ACTIONS 2001
...
- (void)viewDidLoad {
    ...
    {
        _actionButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemTrash target:self action:@selector(actionDeleteBtnPressed:)];
    }
...
{
    if (actionSheet.tag == ACTION_SHEET_DELETE_ACTIONS) {
...
- (void)actionDeleteBtnPressed:(id)sender {
