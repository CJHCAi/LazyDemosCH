...
- (void)setUpTKImageView {
    ...
    _tkImageView.cropAreaBorderLineColor = [UIColor blueColor];
    ...
    _tkImageView.cropAreaMidLineColor = [UIColor yellowColor];
   
    /**交叉线*/
    _tkImageView.cropAreaCrossLineColor = [UIColor orangeColor];
