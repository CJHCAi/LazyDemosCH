...
+ (JDStatusBarStyle*)defaultStyleWithName:(NSString*)styleName;
{
    ...
    // JDStatusBarStyleError
        ...
        style.barColor = [UIColor colorWithRed:224.0 / 255.0 green:48.0 / 255.0 blue:47.0 / 255.0 alpha:1.000];
    ...
    // JDStatusBarStyleSuccess
        ...
        style.barColor = [UIColor colorWithRed:103.0 / 255.0 green:225.0 / 255.0 blue:47.0 / 255.0 alpha:1.000];
        //style.textColor = [UIColor whiteColor];
        style.textColor = [UIColor darkGrayColor];
