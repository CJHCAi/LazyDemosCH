...
- (void)setAndFadeInFacebookImageWithURLs:(NSURL *)url {
    [self setAndFadeInFacebookImageWithURL:url placeholder:nil];
}


- (void)setAndFadeInFacebookImageWithURLs:(NSURL *)url placeholder:(UIImage *)placeholder {
    ...
    [weakImageView hnk_setImageFromURL:url];
