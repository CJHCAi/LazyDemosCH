...
- (void)setDefaultValues
{
    ...
    self.dayCircleColorSelected = [UIColor colorWithRed:234./256. green:93./256. blue:56./256. alpha:1.];
    ...
    self.dayCircleColorToday = [UIColor colorWithRed:66/256. green:88/256. blue:153/256. alpha:1];
