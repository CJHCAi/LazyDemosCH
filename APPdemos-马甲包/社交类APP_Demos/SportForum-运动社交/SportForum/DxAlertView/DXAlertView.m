...
#define kSingleButtonWidth 120.0f
#define kCoupleButtonWidth 107.0f
#define kButtonHeight 38.0f
   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        self.alertTitleLabel.textColor = [UIColor colorWithRed:41.0/255.0 green:173.0/255.0 blue:240.0/255.0 alpha:1.0];
        self.alertTitleLabel.textAlignment = NSTextAlignmentCenter;
        [self addSubview:self.alertTitleLabel];
        
        contentView.frame = CGRectMake((kAlertWidth - CGRectGetWidth(contentView.frame)) * 0.5, CGRectGetMaxY(self.alertTitleLabel.frame), CGRectGetWidth(contentView.frame), CGRectGetHeight(contentView.frame));
        ...
        [self.rightBtn setBackgroundImage:[UIImage imageNamed:@"btn-3-yellow"] forState:UIControlStateNormal];
        [self.leftBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:227.0/255.0 green:100.0/255.0 blue:83.0/255.0 alpha:1]] forState:UIControlStateNormal];
        [self.rightBtn setTitle:rigthTitle forState:UIControlStateNormal];
        [self.leftBtn setTitle:leftTitle forState:UIControlStateNormal];
        self.leftBtn.titleLabel.font = self.rightBtn.titleLabel.font = [UIFont boldSystemFontOfSize:14];
        [self.leftBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [self.rightBtn setTitleColor:[UIColor colorWithRed:141.0 / 255.0 green:78.0 / 255.0 blue:3.0 / 255.0 alpha:1.0] forState:UIControlStateNormal];
