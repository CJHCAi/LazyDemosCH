...
@interface KTMeasonyAutoLayoutCell ()
...
// 图片
@property(nonatomic ,strong) KTCommitPhotoView *photosView;
// 分割线
@property(nonatomic ,strong) UIView         *line;
@end


@implementation KTMeasonyAutoLayoutCell
...
-(void)setUpAllView{
    ...
    // 图片
    self.photosView = [[KTCommitPhotoView alloc]init];
    ...
    // 注意  不管你的布局是怎样的 ，一定要有一个(最好是最底部的控件)相对 contentView.bottom的约束，否则计算cell的高度的时候会不正确！
