 ...
 */
typedef void (^FootSheetDidSelectSheetBlock)(SRActionSheet *actionSheetView, NSInteger index);

@interface SRActionSheet : UIView

@property (nonatomic, weak) id<SRActionSheetDelegate> delegate;

@property (nonatomic, copy) FootSheetDidSelectSheetBlock selectSheetBlock;
