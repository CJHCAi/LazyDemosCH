...
{
    return ((IntroModel*)pages[currentPhotoNum > 0 ? currentPhotoNum : 0]).image;
}
...
{
    [scrollView setContentOffset:CGPointMake((nPageNum == pages.count ? 0 : nPageNum)*self.frame.size.width, 0) animated:YES];
}
