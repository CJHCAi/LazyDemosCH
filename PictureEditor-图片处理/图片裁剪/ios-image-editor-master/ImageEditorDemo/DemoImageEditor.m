...
- (IBAction)testImageViewClicked:(id)sender {
    TestImageViewController * testViewVC = [[TestImageViewController alloc] init];
    [self.navigationController pushViewController:testViewVC animated:nil];
}
