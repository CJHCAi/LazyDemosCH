...
+ (void)showInfoWithStatus:(NSString*)status hidewithInterVal:(float)interval maskType:(SVProgressHUDMaskType)maskType __attribute__((deprecated("Use showInfoWithStatus: and setDefaultMaskType: instead.")));
+ (void)showSuccessWithStatus:(NSString*)status hidewithInterVal:(float)interval;
+ (void)showSuccessWithStatus:(NSString*)status hidewithInterVal:(float)interval maskType:(SVProgressHUDMaskType)maskType __attribute__((deprecated("Use showSuccessWithStatus: and setDefaultMaskType: instead.")));
+ (void)showErrorWithStatus:(NSString*)status hideInterVal:(float)interval;
+ (void)showErrorWithStatus:(NSString*)status hideInterVal:(float)interval maskType:(SVProgressHUDMaskType)maskType __attribute__((deprecated("Use showErrorWithStatus: and setDefaultMaskType: instead.")));

// shows a image + status, use 28x28 white PNGs
+ (void)showImage:(UIImage*)image status:(NSString*)status  hideInterVal:(float)interval;
+ (void)showImage:(UIImage*)image status:(NSString*)status hideInterVal:(float)interval maskType:(SVProgressHUDMaskType)maskType __attribute__((deprecated("Use showImage:status: and setDefaultMaskType: instead.")));
