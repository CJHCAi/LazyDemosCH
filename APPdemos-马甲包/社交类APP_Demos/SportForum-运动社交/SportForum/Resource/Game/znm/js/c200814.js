...
function renderBeginningText() {
	...
	/*加提示语*/
	renderText(trueCanvas.width / 2 + 0 * settings.scale, trueCanvas.height / 2 - 121 * settings.scale+15,
		16, "#2c3e50", "旋转六边形,左右或上下三个同颜色的即可消除。", "16px 微软雅黑");
