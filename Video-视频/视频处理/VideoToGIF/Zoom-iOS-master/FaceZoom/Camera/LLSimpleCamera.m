...
- (void)viewDidLoad {
    ...
    [UIView animateWithDuration:0.4
                     ...
                     animations:^{
                         self.view.frame = CGRectMake(-20, 148.5, [UIScreen mainScreen].bounds.size.width-20, [UIScreen mainScreen].bounds.size.width-20);
                     ...
                     completion:^(BOOL finished){
                         ...
                         [UIView animateWithDuration:0.2
                                             ...
                                             options: UIViewAnimationCurveLinear
                                          animations:^{
                                              self.view.frame =  CGRectMake(10 , 148.5, [UIScreen mainScreen].bounds.size.width-20, [UIScreen mainScreen].bounds.size.width-20);}
                                          completion:nil                   ];
                     }];
...
- (void)initialize {
    if(!_session) {
        ...
        self.captureVideoPreviewLayer.cornerRadius = 20.0f;
