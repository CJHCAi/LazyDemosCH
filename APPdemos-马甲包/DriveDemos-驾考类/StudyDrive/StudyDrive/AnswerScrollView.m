...
-(CGFloat)tableView:(UITableView *)tableView heightForFooterInSection:(NSInteger)section{
    ...
    return [Tools getSizeWithStrng:str with:font withSize:CGSizeMake(tableView.frame.size.width-20, 400)].height+20;
...
-(CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section{
    ...
    if ([model.mtype intValue]==1) {
        ...
        UIFont * font = [UIFont systemFontOfSize:16];
         hight= [Tools getSizeWithStrng:[NSString stringWithFormat:@"%d.%@",[self getQuestuionNumber:tableView andCurrentPage:_currentPage],str] with:font withSize:CGSizeMake(tableView.frame.size.width-20, 400)].height+20;
    }else{
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    UIFont * font = [UIFont systemFontOfSize:16];
    hight= [Tools getSizeWithStrng:str with:font withSize:CGSizeMake(tableView.frame.size.width-20, 400)].height+20;
    ...
    int page = [self getQuestuionNumber:tableView andCurrentPage:_currentPage];
...
-(UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    UIView * view = [[UIView alloc]initWithFrame:CGRectMake(0, 0, SIZE.width, hight)];
    UILabel * label = [[UILabel alloc]initWithFrame:CGRectMake(10, 10, tableView.frame.size.width-20, hight-20)];
    label.text=[NSString stringWithFormat:@"%d.%@",[self getQuestuionNumber:tableView andCurrentPage:_currentPage],str];
    label.font=[UIFont systemFontOfSize:16];
    label.numberOfLines=0;
    [view addSubview:label];
...
-(int)getQuestuionNumber:(UITableView *)tableView andCurrentPage:(int)page{
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (cell==nil) {
        ...
        cell.nubmerLabel.layer.masksToBounds=YES;
        cell.nubmerLabel.layer.cornerRadius=10;
        cell.selectionStyle=UITableViewCellSelectionStyleNone;
    }
    cell.nubmerLabel.text=[NSString stringWithFormat:@"%c",(char)('A'+indexPath.row)];
    AnswerModel *  model = [self getTheFitModel:tableView];
    if ([model.mtype intValue]==1) {
