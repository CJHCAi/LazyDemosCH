...
- (IBAction)button1Tapped:(id)sender {
    ...
    NSURL *videoURL = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"ysw1" ofType:@"MP4"]];
    
    [NSGIF createGIFfromURL:videoURL withFrameCount:5 delayTime:0.2 loopCount:NO completion:^(NSURL *GifURL) {
